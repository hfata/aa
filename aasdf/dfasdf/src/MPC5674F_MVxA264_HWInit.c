...
/*
 *
 * FILE : MPC5674F_HWInit.c
 *
 * DESCRIPTION:
 *  This file contains all MPC5674F derivative needed initializations, 
 *  and all initializations for the MPC5674F boards which are supported.
...
#include "MPC5674F_MVxA264.h"       /* MPC55xx platform development header            */
#include "MPC5674F_MVxA264_HWInit.h"
...
/*******************************************************/
/* MPC5674F derivative specific hardware initialization */
/*******************************************************/

/* Symbol L2SRAM_LOCATION is defined in the application linker command file (.lcf) 
   It is defined to the start of the L2SRAM of the MPC5674F. 
*/
...
/*******************************************************/
/* MPC5674F boards specific hardware initializations    */
/*******************************************************/
...
#if INIT_USED_BOARD==MPC5674FDEMO_AXM_0321
/* Symbol AXM_0321_EXTERNAL_RAM is defined in the application linker command file (.lcf) 
   It is defined to the start of the external memory on the MPC5674FDEMO_AXM-0321 board 
*/
...
nofralloc
    ...
    /*  This initializes the MPC5674 external bus
        Set up the pins
